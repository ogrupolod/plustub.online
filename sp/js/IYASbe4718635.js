...
(function () {
  try {
    const clickeventList = [
      { compKey: "44f131e", misc: { type: "button" } },
      { compKey: "bd554fe", misc: { type: "button" } },
      { compKey: "8f2ab85", misc: { type: "button" } },
      { compKey: "5c31963", misc: { type: "text" } },
      { compKey: "9cee902", misc: { type: "text" } },
    ];
...
(function () {
  try {
    const animationList = [
      { key: "6ee6bbc", type: "text" },
      { key: "b1b189d", type: "text" },
      { key: "b65fb75", type: "text" },
    ];
